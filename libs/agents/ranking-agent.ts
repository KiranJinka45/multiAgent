...
export class RankingAgent extends BaseAgent {
    ...
    async execute(input: RankingInput, context: AgentContext): Promise<AgentResponse<RankingOutput>> {
        void context;
...
Output strictly valid JSON:
{
  ...
  "justification": "Why this version is superior"
        ...
        const { result, tokens } = await this.promptLLM(system, userPrompt, 'llama-3.3-70b-versatile');
