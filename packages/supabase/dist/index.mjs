...
var require_dist = __commonJS({
  "../../node_modules/.pnpm/@supabase+auth-helpers-nextjs@0.10.0_@supabase+supabase-js@2.100.0/node_modules/@supabase/auth-helpers-nextjs/dist/index.js"(exports, module) {
    "use strict";
...
function createBrowserSupabaseClient(config) {
  ...
  if (!_browserClient) {
    ...
    _browserClient = createClient2(config.url, config.anonKey);
...
var export_createClientComponentClient = import_auth_helpers_nextjs.createClientComponentClient;
export {
  createBrowserSupabaseClient,
  export_createClientComponentClient as createClientComponentClient,
