...
const src_1 = require("../../packages/events/src");
const src_2 = require("../../packages/db/src");
const mission_recorder_1 = require("../src/mission-recorder");
/**
...
async function runChaosTest() {
    ...
    for (let i = 1; i <= 5; i++) {
        await src_1.eventBus.publish(streamKey, {
    ...
    await (0, mission_recorder_1.setupMissionRecorder)();
    ...
    // 5. Verify DB
    const count = await src_2.db.executionLog.count({
...
//# sourceMappingURL=chaos-event-test.js.map