...
import { Rocket, Shield, Zap, Terminal } from "lucide-react";
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-12">
          {[
            ...
            { icon: Shield, title: "Auth Secure", desc: "Hardened security patterns pre-integrated." },
            { icon: Zap, title: "AI Optimized", desc: "Clean architecture for autonomous expansion." }
          ].map((feature, i) => (
            <div key={i} className="p-6 bg-white/[0.02] border border-white/5 rounded-2xl text-left hover:bg-white/[0.04] transition-all">
