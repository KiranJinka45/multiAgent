...
async function simulateRollbackValidation() {
    ...
    const token = jsonwebtoken_1.default.sign({ id: 'sre-test', roles: ['admin'], tenantId: 'system' }, JWT_SECRET);
    const headers = {
    ...
    for (let i = 0; i < count; i++) {
        ...
        try {
            await axios_1.default.get(`${GATEWAY_URL}/health`, { headers, timeout: 5000 });
...
//# sourceMappingURL=simulate-rollback-validation.js.map