...
async function runBusinessSmokeTest() {
    ...
    try {
        ...
        await axios_1.default.post(`${GATEWAY_URL}/api/events`, {
            type: 'page_view',
        ...
        const eventCount = await db_1.db.event.count({
        ...
        const checkoutRes = await axios_1.default.post(`${GATEWAY_URL}/api/checkout`, {
...
//# sourceMappingURL=business-smoke-test.js.map