...
async function runMemoryStabilityTest() {
    ...
    const token = jsonwebtoken_1.default.sign(testUser, JWT_SECRET, { expiresIn: '2h' });
    ...
    const submitJobs = async () => {
        while (Date.now() - startTime < TEST_DURATION_MS) {
            try {
                await axios_1.default.post(`${API_URL}/generate`, {
...
//# sourceMappingURL=sre-memory-stability.js.map