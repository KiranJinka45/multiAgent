...
async function simulateUser(id) {
    ...
    // 1. Fetch Projects
    await (0, utils_1.request)("/api/projects", "GET", null, INTERNAL_KEY);
    // 2. Fetch Missions
    await (0, utils_1.request)("/api/missions", "GET", null, INTERNAL_KEY);
    // 3. Create a stress mission
    await (0, utils_1.request)("/api/missions/start", "POST", {
